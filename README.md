...
Este repositório contém uma API RESTful completa para gerenciamento de usuários. O objetivo principal do projeto é demonstrar a implementação de um CRUD completo (Create, Read, Update, Delete) seguindo as melhores práticas do ecossistema Spring, com foco na qualidade de software através de **Testes Unitários de Endpoints**, **Testes do repositório JPA** e **Testes de regra de negócio**.
